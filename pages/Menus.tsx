...
interface MenusPageProps {
  ...
  onSync: (menu: Menu) => void;
  onSyncDelete: (id: string) => void;
}

export const MenusPage: React.FC<MenusPageProps> = ({ t, menus, setMenus, onSync, onSyncDelete }) => {
  ...
  const handleSave = () => {
    ...
    if (editingMenu) {
      const updatedMenu = { ...editingMenu, name: trimmedName };
