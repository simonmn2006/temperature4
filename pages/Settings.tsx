...
export const SettingsPage: React.FC<{ 
  ...
  onSyncHoliday: (h: Holiday) => void;
  onSyncFridgeType: (ft: RefrigeratorType) => void;
  onSyncCooking: (cm: CookingMethod) => void;
  onSyncFacilityType: (ft: FacilityType) => void;
  onSyncException: (ex: FacilityException) => void;
  onSyncExceptionDelete: (id: string) => void;
  onSyncLegal: (legal: { imprint: string; privacy: string }) => void;
}> = ({ 
  t, facilities, fridgeTypes, setFridgeTypes, cookingMethods, setCookingMethods, facilityTypes, setFacilityTypes, 
  holidays, setHolidays, excludedFacilities, setExcludedFacilities, legalTexts, setLegalTexts,
  onSyncHoliday, onSyncFridgeType, onSyncCooking, onSyncFacilityType, onSyncException, onSyncExceptionDelete, onSyncLegal
}) => {
  ...
  const executeDelete = () => {
    ...
    else if (type === 'excludedFacilities') {
        setExcludedFacilities(prev => prev.filter(x => x.id !== item.id));
        onSyncExceptionDelete(item.id);
    }
